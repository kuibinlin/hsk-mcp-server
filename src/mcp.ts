...
const SERVER_INSTRUCTIONS = [
  ...
  "",
  "Tool routing guide:",
  "- For word lookup by characters or pinyin: hsk.lookup",
  "- For frequency/rarity info: hsk.frequency",
  "- For transcription systems (pinyin, Wade-Giles, Bopomofo, Romatzyh): hsk.convert_script",
  "- For simplified ↔ traditional conversion: hsk.convert_characters",
  "- For measure words: hsk.classifier",
  "- For English meaning search: hsk.search_meaning",
  "- For radical-based search: hsk.words_by_radical",
  "- For characters with multiple readings: hsk.polyphones",
  "- For same-sound words: hsk.homophones",
  "- For level word lists: hsk.build_study_set",
  "- For personalized suggestions: hsk.suggest_next (pass known words to exclude them)",
  "- For side-by-side word comparison: hsk.compare",
  "- For level overlap/differences: hsk.diff",
  "",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "Use hsk.build_study_set to get the word list.",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "1. Use hsk.lookup to get full details (meanings, part of speech, HSK level, frequency).",
              "2. Use hsk.convert_script to show all transcription systems.",
              "3. Use hsk.classifier to check if it has a measure word.",
              "4. Use hsk.homophones to find words with the same pinyin.",
